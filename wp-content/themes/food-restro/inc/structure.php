...
if ( ! function_exists( 'food_restro_footer_site_info' ) ) :
	...
	function food_restro_footer_site_info() {
		...
		<div class="site-info col-2">
                <div class="wrapper BottomFooter">
					<div class="FooterLogo"><?php the_custom_logo(); ?></div>
                    ...
                    <div class="BottomRight"><?php //echo food_restro_santize_allow_tag( $powered_by_text ); ?>
