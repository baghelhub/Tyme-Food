...
function autoship_set_order_created_scheduled_orders_key( $order_id, $vals ){
  ...
  update_post_meta( $order_id, '_autoship_created_scheduled_orders_key', $vals, false );
  return $vals;
...
function autoship_set_order_created_scheduled_orders_error( $order_id, $notice = '' ){
  ...
  update_post_meta( $order_id, '_autoship_created_scheduled_orders_error', $notice, false );
...
function autoship_set_scheduled_order_expected_count( $order, $count ){
  ...
  // set the count
  update_post_meta( $order->get_id(), '_autoship_scheduled_order_expected_count', $count, false );
...
function autoship_flag_if_scheduled_order_related( $order, $source = '' ){
  ...
  if ( 'result' === $source || 'source' === $source ){
    ...
    // set the flag
    update_post_meta( $order->get_id(), '_autoship_scheduled_order_type', $source, false );
...
function autoship_update_scheduled_orders_on_processing( $order_id ) {
  ...
  $payment_method = strtolower( get_post_meta( $order_id, '_payment_method', true ) );
