...
$subnotice_format ='<mark class="order-quantity">%1$d</mark> %2$s<mark class="order-frequency">%3$s</mark>';
...
sprintf( $subnotice_format, $item_count,  __( 'item(s) currently scheduled for ', 'autoship' ), $autoship_order['frequencyDisplayName'] ):
sprintf( $subnotice_format, $item_count, __( 'item(s) currently paused but originally scheduled for ', 'autoship' ), $autoship_order['frequencyDisplayName'] );
