	...
	public function getSettings()
	{
		$settings = [
			...
			'content' => [
				'popup_size' => [
					'title' => [
						'title' => firebox()->_('FB_METABOX_DESIGN_POPUP_SIZE'),
						'description' => firebox()->_('FB_METABOX_DESIGN_POPUP_SIZE_DESC')
					],
					'fields' => [
						[
							'name' => 'width_control',
				...
				'box' => [
					'title' => [
						'title' => firebox()->_('FB_METABOX_DESIGN_POPUP'),
						'description' => firebox()->_('FB_METABOX_DESIGN_POPUP_DESC')
					],
					'fields' => [
						[
