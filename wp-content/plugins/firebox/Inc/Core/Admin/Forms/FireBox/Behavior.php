				...
				'base' => [
					...
					'fields' => [
						...
						[
							'name' => 'mode',
							'type' => 'Toggle',
							'label' => firebox()->_('FB_METABOX_BOX_MODE'),
							'description' => firebox()->_('FB_METABOX_BOX_MODE_DESC'),
							'default' => 'popup',
							'choices' => [
								'popup' => firebox()->_('FB_POPUP'),
								'pageslide' => firebox()->_('FB_METABOX_MODE_PAGESLIDE'),
							],
							'class' => ['large-auto']
						]
					]
				...
				'closing_behavior' => [
					...
					'fields' => [
						...
						[
							...
							'default' => 'never',
							'choices' => [
								'never' => firebox()->_('FB_KEEP_SHOWING_POPUP'),
								'ever' => firebox()->_('FB_DO_NOT_SHOW_POPUP_AGAIN'),
								'session' => firebox()->_('FB_DO_NOT_SHOW_POPUP_AGAIN_SESSION'),
								'custom' => firebox()->_('FB_DO_NOT_SHOW_POPUP_AGAIN_PERIOD')
							]
						],
						[
							'type' => 'CustomDiv',
