...
class Library
{
	...
	public function templates_library_set_modal_header_middle()
	{
		...
		{
			?>
			<a href="#" class="fpf-button outline red fpf-modal-opener" data-fpf-modal-item="<?php esc_attr_e(fpframework()->_('FPF_PRO_TEMPLATES')); ?>" data-fpf-modal="#fpfUpgradeToPro">
