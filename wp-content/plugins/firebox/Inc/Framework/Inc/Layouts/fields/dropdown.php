...
?>
<select name="<?php echo esc_attr($this->data->get('name')); ?>"<?php echo wp_kses_data($this->data->get('required_attribute')); ?> id="fpf-control-input-item_<?php echo esc_attr($this->data->get('name_key')); ?>" class="fpf-select-field fpf-control-input-item<?php echo esc_attr($this->data->get('input_class')); ?>">
<?php
