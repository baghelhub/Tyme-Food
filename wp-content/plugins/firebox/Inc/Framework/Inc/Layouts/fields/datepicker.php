...
<div class="fpf-datepicker-parent">
	<input type="text"<?php echo wp_kses_data($this->data->get('required_attribute') . $this->data->get('extra_atts')); ?> id="fpf-control-input-item_<?php esc_attr_e($this->data->get('name_key')); ?>" class="fpf-field-item fpf-control-input-item fpf-datepicker-item<?php esc_attr_e($this->data->get('input_class', '')); ?>" placeholder="<?php esc_attr_e($this->data->get('placeholder', '')); ?>" value="<?php esc_attr_e($value); ?>" name="<?php esc_attr_e($this->data->get('name')); ?>" />
