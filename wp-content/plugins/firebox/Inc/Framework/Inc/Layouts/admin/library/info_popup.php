	...
	<div class="template-details">
		<div class="items grid-x grid-margin-x grid-margin-y">
			...
			<div class="cell small-4 solution">
				<div class="title is-grey"><?php esc_html_e(fpframework()->_('FPF_SOLUTION')); ?>:</div>
				<div class="content"></div>
			</div>
			<div class="cell small-4 goal">
				<div class="title is-grey"><?php esc_html_e(fpframework()->_('FPF_GOAL')); ?>:</div>
				<div class="content"></div>
			</div>
		</div>
	</div>
