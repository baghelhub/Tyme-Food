...
class Translations
{
	...
	public static function getTranslations()
	{
		return [
			...
			'FPF_FONT_SIZE_DESC' => __('Set the popup font size.', 'fpf-framework'),
			...
			'FPF_TAG_FBID' => __('Popup ID', 'fpf-framework'),
			'FPF_TAG_FBTITLE' => __('Popup Title', 'fpf-framework'),
			...
			'FPF_IMPORT_ITEMS' => __('Import Items', 'fpf-framework'),
			...
			'FPF_SELECT_A_FIREBOX_HINT' => __('Start searching for a FireBox popup', 'fpf-framework'),
			'FPF_FIREBOX_VIEWED_ANOTHER_POPUP' => __('FireBox - Viewed Another Popup', 'fpf-framework'),
